...
function $abs_CalleeA_0($strategy:int, $h_pre:Heap, x_0:Ref, $h_post:Heap):bool;

// version _0 of the procedure
procedure CalleeA_0($strategy:int, $h:Heap, $roots:Roots, x:Ref) returns ($h_0:Heap)
    ...
    free ensures $abs_CalleeA_0($strategy, $h, x, $h_0);
...
// abstraction of function behaviour
function $abs_CalleeA_1($strategy:int, $h_pre:Heap, x_1:Ref, $h_post:Heap):bool;

// version _1 of the procedure
procedure CalleeA_1($strategy:int, $h:Heap, $roots:Roots, x:Ref) returns ($h_1:Heap)
    requires $Allocated($h, x);
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
    requires $Roots#Allocated($roots, $h);
    ...
    free ensures $abs_CalleeA_1($strategy, $h, x, $h_1);
...
axiom (forall 
			...
			{
				$abs_CalleeA_0($allocator, $h0_0 , x_0, $hn_0) ,
				$abs_CalleeA_1($allocator, $h0_1 , x_1, $hn_1) 
			}
			$abs_CalleeA_0($allocator, $h0_0 , x_0, $hn_0) &&
			$abs_CalleeA_1($allocator, $h0_1 , x_1, $hn_1) &&
...
// product procedure
procedure CalleeA_CalleeA($h:Heap, $roots:Roots, x:Ref)
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
	requires $Roots#Allocated($roots, $h);
	requires $Allocated($h, x);
...
// abstraction of function behaviour
function $abs_CalleeB_0($strategy:int, $h_pre:Heap, x_0:Ref, $h_post:Heap):bool;

// version _0 of the procedure
procedure CalleeB_0($strategy:int, $h:Heap, $roots:Roots, x:Ref) returns ($h_0:Heap)
    requires $Allocated($h, x);
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
    requires $Roots#Allocated($roots, $h);
    ...
    free ensures $GoodHeap($h_0);
    free ensures $HeapSucc($h, $h_0); // this maybe introduces performance issues
    free ensures $abs_CalleeB_0($strategy, $h, x, $h_0);
    free ensures $Heap#Bigger($h, $h_0);
    free ensures (forall $a:Ref :: // stuff is not pulled out of the garbage
					$Reachable($h_0, $roots, $a) ==>
						$Reachable($h, $roots, $a) || 
...
// abstraction of function behaviour
function $abs_CalleeB_1($strategy:int, $h_pre:Heap, x_1:Ref, $h_post:Heap):bool;

// version _1 of the procedure
procedure CalleeB_1($strategy:int, $h:Heap, $roots:Roots, x:Ref) returns ($h_1:Heap)
    requires $Allocated($h, x);
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
    requires $Roots#Allocated($roots, $h);
    ...
    free ensures $GoodHeap($h_1);
    free ensures $HeapSucc($h, $h_1); // this maybe introduces performance issues
    free ensures $abs_CalleeB_1($strategy, $h, x, $h_1);
    free ensures $Heap#Bigger($h, $h_1);
    free ensures (forall $a:Ref :: // stuff is not pulled out of the garbage
					$Reachable($h_1, $roots, $a) ==>
						$Reachable($h, $roots, $a) || 
...
axiom (forall 
			...
			$h0_1:Heap, x_1:Ref, $hn_1:Heap ::
			{
				$abs_CalleeB_0($allocator, $h0_0 , x_0, $hn_0) ,
				$abs_CalleeB_1($allocator, $h0_1 , x_1, $hn_1) 
			}
			$abs_CalleeB_0($allocator, $h0_0 , x_0, $hn_0) &&
			$abs_CalleeB_1($allocator, $h0_1 , x_1, $hn_1) &&
			$Heap#EqualFromParams#1($h0_0 , x_0, $h0_1 , x_1) ==>
...
// product procedure
procedure CalleeB_CalleeB($h:Heap, $roots:Roots, x:Ref)
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
	requires $Roots#Allocated($roots, $h);
	requires $Allocated($h, x);
     ...
     /* modifies anything */  
{
	...
	x_0 := $Null;
			...
			x_0 := x ;
			assume $ReadObject($h_0, x);
			 call $h_0:=CalleeA_0(0, $h_0, $roots, x_0); 
     ...
     /* modifies anything */  
{
	...
	x_1 := $Null;
			...
			x_1 := x ;
			assume $ReadObject($h_1, x);
			 call $h_1:=CalleeB_1(0, $h_1, $roots, x_1); 
	...
	requires (forall $a:Ref :: $Reachable($h, $roots, $a) ==> $Allocated($h, $a)); // should be an axiom of well formed heaps
{
    ...
    assume $ReadObject($h,x);
		    ...
		    x_0$0 := x$0 ;
		    assume $ReadObject($h_0$0, x$0);
		     call $h_0$0:=CalleeA_0(0, $h_0$0, $roots, x_0$0); 

		    // procedure body _1 start
		    x_1$0 := x$0 ;
		    assume $ReadObject($h_1$0, x$0);
		     call $h_1$0:=CalleeB_1(0, $h_1$0, $roots, x_1$0); 

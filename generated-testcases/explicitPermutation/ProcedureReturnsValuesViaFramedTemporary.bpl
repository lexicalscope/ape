...
function $abs_CopyTree_0($strategy:int, $h_pre:Heap, x_0:Ref,r_0:Ref, $h_post:Heap):bool;

// version _0 of the procedure
procedure CopyTree_0($strategy:int, $h:Heap, $roots:Roots, x:Ref,r:Ref) returns ($h_0:Heap)
    ...
    free ensures $abs_CopyTree_0($strategy, $h, x, r, $h_0);
...
// abstraction of function behaviour
function $abs_CopyTree_1($strategy:int, $h_pre:Heap, x_1:Ref,r_1:Ref, $h_post:Heap):bool;

// version _1 of the procedure
procedure CopyTree_1($strategy:int, $h:Heap, $roots:Roots, x:Ref,r:Ref) returns ($h_1:Heap)
    requires $Allocated($h, x) && $Allocated($h, r);
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
    requires $Roots#Allocated($roots, $h);
    ...
    free ensures $abs_CopyTree_1($strategy, $h, x, r, $h_1);
...
axiom (forall 
			...
			{
				$abs_CopyTree_0($allocator, $h0_0 , x_0, r_0, $hn_0) ,
				$abs_CopyTree_1($allocator, $h0_1 , x_1, r_1, $hn_1) 
			}
			$abs_CopyTree_0($allocator, $h0_0 , x_0, r_0, $hn_0) &&
			$abs_CopyTree_1($allocator, $h0_1 , x_1, r_1, $hn_1) &&
...
// product procedure
procedure CopyTree_CopyTree($h:Heap, $roots:Roots, x:Ref,r:Ref)
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
	requires $Roots#Allocated($roots, $h);
	requires $Allocated($h, x) && $Allocated($h, r);
    ...
    assume $ReadObject($h,r);
		    ...
		    if((x_0$0  != $Null ) )
		    {
		    	if((r_0$0  != $Null ) )
		    	{
		    		...
		    		$t#3_0$0 := $Read($h_0$0,x_0$0,$field#f) ;
		    		assume $ReadObject($h_0$0, x_0$0);
		    		assume $ReadObject($h_0$0, $Read($h_0$0,x_0$0,$field#f) );
		    		t0_0$0 := $t#3_0$0 ;
		    		assume $ReadObject($h_0$0, $t#3_0$0);
		    		 call $h_0$0:=CopyTree_0(0, $h_0$0, $roots, t0_0$0, r0_0$0); 
		    		$t#4_0$0 := $Read($h_0$0,x_0$0,$field#g) ;
		    		assume $ReadObject($h_0$0, x_0$0);
		    		assume $ReadObject($h_0$0, $Read($h_0$0,x_0$0,$field#g) );
		    		t1_0$0 := $t#4_0$0 ;
		    		assume $ReadObject($h_0$0, $t#4_0$0);
		    		 call $h_0$0:=CopyTree_0(0, $h_0$0, $roots, t1_0$0, r1_0$0); 
		    		$t#5_0$0 := $Read($h_0$0,r0_0$0,$field#v) ;
		    		assume $ReadObject($h_0$0, r0_0$0);
		    		assume $ReadObject($h_0$0, $Read($h_0$0,r0_0$0,$field#v) );
		    		$h_0$0:=$Write($h_0$0,n_0$0,$field#f,$t#5_0$0); assume $GoodHeap($h_0$0);
		    		$t#6_0$0 := $Read($h_0$0,r1_0$0,$field#v) ;
		    		assume $ReadObject($h_0$0, r1_0$0);
		    		assume $ReadObject($h_0$0, $Read($h_0$0,r1_0$0,$field#v) );
		    		$h_0$0:=$Write($h_0$0,n_0$0,$field#g,$t#6_0$0); assume $GoodHeap($h_0$0);
		    ...
		    if((x_0$1  != $Null ) )
		    {
		    	if((r_0$1  != $Null ) )
		    	{
		    		...
		    		$t#3_0$1 := $Read($h_0$1,x_0$1,$field#f) ;
		    		assume $ReadObject($h_0$1, x_0$1);
		    		assume $ReadObject($h_0$1, $Read($h_0$1,x_0$1,$field#f) );
		    		t0_0$1 := $t#3_0$1 ;
		    		assume $ReadObject($h_0$1, $t#3_0$1);
		    		 call $h_0$1:=CopyTree_0(1, $h_0$1, $roots, t0_0$1, r0_0$1); 
		    		$t#4_0$1 := $Read($h_0$1,x_0$1,$field#g) ;
		    		assume $ReadObject($h_0$1, x_0$1);
		    		assume $ReadObject($h_0$1, $Read($h_0$1,x_0$1,$field#g) );
		    		t1_0$1 := $t#4_0$1 ;
		    		assume $ReadObject($h_0$1, $t#4_0$1);
		    		 call $h_0$1:=CopyTree_0(1, $h_0$1, $roots, t1_0$1, r1_0$1); 
		    		$t#5_0$1 := $Read($h_0$1,r0_0$1,$field#v) ;
		    		assume $ReadObject($h_0$1, r0_0$1);
		    		assume $ReadObject($h_0$1, $Read($h_0$1,r0_0$1,$field#v) );
		    		$h_0$1:=$Write($h_0$1,n_0$1,$field#f,$t#5_0$1); assume $GoodHeap($h_0$1);
		    		$t#6_0$1 := $Read($h_0$1,r1_0$1,$field#v) ;
		    		assume $ReadObject($h_0$1, r1_0$1);
		    		assume $ReadObject($h_0$1, $Read($h_0$1,r1_0$1,$field#v) );
		    		$h_0$1:=$Write($h_0$1,n_0$1,$field#g,$t#6_0$1); assume $GoodHeap($h_0$1);
		    ...
		    if((x_0$2  != $Null ) )
		    {
		    	if((r_0$2  != $Null ) )
		    	{
		    		...
		    		$t#3_0$2 := $Read($h_0$2,x_0$2,$field#f) ;
		    		assume $ReadObject($h_0$2, x_0$2);
		    		assume $ReadObject($h_0$2, $Read($h_0$2,x_0$2,$field#f) );
		    		t0_0$2 := $t#3_0$2 ;
		    		assume $ReadObject($h_0$2, $t#3_0$2);
		    		 call $h_0$2:=CopyTree_0(2, $h_0$2, $roots, t0_0$2, r0_0$2); 
		    		$t#4_0$2 := $Read($h_0$2,x_0$2,$field#g) ;
		    		assume $ReadObject($h_0$2, x_0$2);
		    		assume $ReadObject($h_0$2, $Read($h_0$2,x_0$2,$field#g) );
		    		t1_0$2 := $t#4_0$2 ;
		    		assume $ReadObject($h_0$2, $t#4_0$2);
		    		 call $h_0$2:=CopyTree_0(2, $h_0$2, $roots, t1_0$2, r1_0$2); 
		    		$t#5_0$2 := $Read($h_0$2,r0_0$2,$field#v) ;
		    		assume $ReadObject($h_0$2, r0_0$2);
		    		assume $ReadObject($h_0$2, $Read($h_0$2,r0_0$2,$field#v) );
		    		$h_0$2:=$Write($h_0$2,n_0$2,$field#f,$t#5_0$2); assume $GoodHeap($h_0$2);
		    		$t#6_0$2 := $Read($h_0$2,r1_0$2,$field#v) ;
		    		assume $ReadObject($h_0$2, r1_0$2);
		    		assume $ReadObject($h_0$2, $Read($h_0$2,r1_0$2,$field#v) );
		    		$h_0$2:=$Write($h_0$2,n_0$2,$field#g,$t#6_0$2); assume $GoodHeap($h_0$2);
		    ...
		    if((x_1$2  != $Null ) )
		    {
		    	if((r_1$2  != $Null ) )
		    	{
		    		...
		    		$t#2_1$2 := $Read($h_1$2,x_1$2,$field#g) ;
		    		assume $ReadObject($h_1$2, x_1$2);
		    		assume $ReadObject($h_1$2, $Read($h_1$2,x_1$2,$field#g) );
		    		t0_1$2 := $t#2_1$2 ;
		    		assume $ReadObject($h_1$2, $t#2_1$2);
		    		 call $h_1$2:=CopyTree_1(2, $h_1$2, $roots, t0_1$2, r1_1$2); 
		    		$t#3_1$2 := $Read($h_1$2,x_1$2,$field#f) ;
		    		assume $ReadObject($h_1$2, x_1$2);
		    		assume $ReadObject($h_1$2, $Read($h_1$2,x_1$2,$field#f) );
		    		t1_1$2 := $t#3_1$2 ;
		    		assume $ReadObject($h_1$2, $t#3_1$2);
		    		 call $h_1$2:=CopyTree_1(2, $h_1$2, $roots, t1_1$2, r0_1$2); 
		    		$t#4_1$2 := $a#2_1$2 ;
		    		assume $ReadObject($h_1$2, $a#2_1$2);
		    		n_1$2 := $t#4_1$2 ;
		    		assume $ReadObject($h_1$2, $t#4_1$2);
		    		$t#5_1$2 := $Read($h_1$2,r0_1$2,$field#v) ;
		    		assume $ReadObject($h_1$2, r0_1$2);
		    		assume $ReadObject($h_1$2, $Read($h_1$2,r0_1$2,$field#v) );
		    		$h_1$2:=$Write($h_1$2,n_1$2,$field#f,$t#5_1$2); assume $GoodHeap($h_1$2);
		    		$t#6_1$2 := $Read($h_1$2,r1_1$2,$field#v) ;
		    		assume $ReadObject($h_1$2, r1_1$2);
		    		assume $ReadObject($h_1$2, $Read($h_1$2,r1_1$2,$field#v) );
		    		$h_1$2:=$Write($h_1$2,n_1$2,$field#g,$t#6_1$2); assume $GoodHeap($h_1$2);
		    ...
		    if((x_0$3  != $Null ) )
		    {
		    	if((r_0$3  != $Null ) )
		    	{
		    		...
		    		$t#3_0$3 := $Read($h_0$3,x_0$3,$field#f) ;
		    		assume $ReadObject($h_0$3, x_0$3);
		    		assume $ReadObject($h_0$3, $Read($h_0$3,x_0$3,$field#f) );
		    		t0_0$3 := $t#3_0$3 ;
		    		assume $ReadObject($h_0$3, $t#3_0$3);
		    		 call $h_0$3:=CopyTree_0(3, $h_0$3, $roots, t0_0$3, r0_0$3); 
		    		$t#4_0$3 := $Read($h_0$3,x_0$3,$field#g) ;
		    		assume $ReadObject($h_0$3, x_0$3);
		    		assume $ReadObject($h_0$3, $Read($h_0$3,x_0$3,$field#g) );
		    		t1_0$3 := $t#4_0$3 ;
		    		assume $ReadObject($h_0$3, $t#4_0$3);
		    		 call $h_0$3:=CopyTree_0(3, $h_0$3, $roots, t1_0$3, r1_0$3); 
		    		$t#5_0$3 := $Read($h_0$3,r0_0$3,$field#v) ;
		    		assume $ReadObject($h_0$3, r0_0$3);
		    		assume $ReadObject($h_0$3, $Read($h_0$3,r0_0$3,$field#v) );
		    		$h_0$3:=$Write($h_0$3,n_0$3,$field#f,$t#5_0$3); assume $GoodHeap($h_0$3);
		    		$t#6_0$3 := $Read($h_0$3,r1_0$3,$field#v) ;
		    		assume $ReadObject($h_0$3, r1_0$3);
		    		assume $ReadObject($h_0$3, $Read($h_0$3,r1_0$3,$field#v) );
		    		$h_0$3:=$Write($h_0$3,n_0$3,$field#g,$t#6_0$3); assume $GoodHeap($h_0$3);
		    ...
		    if((x_1$3  != $Null ) )
		    {
		    	if((r_1$3  != $Null ) )
		    	{
		    		...
		    		$t#2_1$3 := $Read($h_1$3,x_1$3,$field#g) ;
		    		assume $ReadObject($h_1$3, x_1$3);
		    		assume $ReadObject($h_1$3, $Read($h_1$3,x_1$3,$field#g) );
		    		t0_1$3 := $t#2_1$3 ;
		    		assume $ReadObject($h_1$3, $t#2_1$3);
		    		 call $h_1$3:=CopyTree_1(3, $h_1$3, $roots, t0_1$3, r1_1$3); 
		    		$t#3_1$3 := $Read($h_1$3,x_1$3,$field#f) ;
		    		assume $ReadObject($h_1$3, x_1$3);
		    		assume $ReadObject($h_1$3, $Read($h_1$3,x_1$3,$field#f) );
		    		t1_1$3 := $t#3_1$3 ;
		    		assume $ReadObject($h_1$3, $t#3_1$3);
		    		 call $h_1$3:=CopyTree_1(3, $h_1$3, $roots, t1_1$3, r0_1$3); 
		    		$t#4_1$3 := $a#2_1$3 ;
		    		assume $ReadObject($h_1$3, $a#2_1$3);
		    		n_1$3 := $t#4_1$3 ;
		    		assume $ReadObject($h_1$3, $t#4_1$3);
		    		$t#5_1$3 := $Read($h_1$3,r0_1$3,$field#v) ;
		    		assume $ReadObject($h_1$3, r0_1$3);
		    		assume $ReadObject($h_1$3, $Read($h_1$3,r0_1$3,$field#v) );
		    		$h_1$3:=$Write($h_1$3,n_1$3,$field#f,$t#5_1$3); assume $GoodHeap($h_1$3);
		    		$t#6_1$3 := $Read($h_1$3,r1_1$3,$field#v) ;
		    		assume $ReadObject($h_1$3, r1_1$3);
		    		assume $ReadObject($h_1$3, $Read($h_1$3,r1_1$3,$field#v) );
		    		$h_1$3:=$Write($h_1$3,n_1$3,$field#g,$t#6_1$3); assume $GoodHeap($h_1$3);
		    ...
		    if((x_0$4  != $Null ) )
		    {
		    	if((r_0$4  != $Null ) )
		    	{
		    		...
		    		$t#3_0$4 := $Read($h_0$4,x_0$4,$field#f) ;
		    		assume $ReadObject($h_0$4, x_0$4);
		    		assume $ReadObject($h_0$4, $Read($h_0$4,x_0$4,$field#f) );
		    		t0_0$4 := $t#3_0$4 ;
		    		assume $ReadObject($h_0$4, $t#3_0$4);
		    		 call $h_0$4:=CopyTree_0(4, $h_0$4, $roots, t0_0$4, r0_0$4); 
		    		$t#4_0$4 := $Read($h_0$4,x_0$4,$field#g) ;
		    		assume $ReadObject($h_0$4, x_0$4);
		    		assume $ReadObject($h_0$4, $Read($h_0$4,x_0$4,$field#g) );
		    		t1_0$4 := $t#4_0$4 ;
		    		assume $ReadObject($h_0$4, $t#4_0$4);
		    		 call $h_0$4:=CopyTree_0(4, $h_0$4, $roots, t1_0$4, r1_0$4); 
		    		$t#5_0$4 := $Read($h_0$4,r0_0$4,$field#v) ;
		    		assume $ReadObject($h_0$4, r0_0$4);
		    		assume $ReadObject($h_0$4, $Read($h_0$4,r0_0$4,$field#v) );
		    		$h_0$4:=$Write($h_0$4,n_0$4,$field#f,$t#5_0$4); assume $GoodHeap($h_0$4);
		    		$t#6_0$4 := $Read($h_0$4,r1_0$4,$field#v) ;
		    		assume $ReadObject($h_0$4, r1_0$4);
		    		assume $ReadObject($h_0$4, $Read($h_0$4,r1_0$4,$field#v) );
		    		$h_0$4:=$Write($h_0$4,n_0$4,$field#g,$t#6_0$4); assume $GoodHeap($h_0$4);
		    ...
		    if((x_1$4  != $Null ) )
		    {
		    	if((r_1$4  != $Null ) )
		    	{
		    		...
		    		$t#2_1$4 := $Read($h_1$4,x_1$4,$field#g) ;
		    		assume $ReadObject($h_1$4, x_1$4);
		    		assume $ReadObject($h_1$4, $Read($h_1$4,x_1$4,$field#g) );
		    		t0_1$4 := $t#2_1$4 ;
		    		assume $ReadObject($h_1$4, $t#2_1$4);
		    		 call $h_1$4:=CopyTree_1(4, $h_1$4, $roots, t0_1$4, r1_1$4); 
		    		$t#3_1$4 := $Read($h_1$4,x_1$4,$field#f) ;
		    		assume $ReadObject($h_1$4, x_1$4);
		    		assume $ReadObject($h_1$4, $Read($h_1$4,x_1$4,$field#f) );
		    		t1_1$4 := $t#3_1$4 ;
		    		assume $ReadObject($h_1$4, $t#3_1$4);
		    		 call $h_1$4:=CopyTree_1(4, $h_1$4, $roots, t1_1$4, r0_1$4); 
		    		$t#4_1$4 := $a#2_1$4 ;
		    		assume $ReadObject($h_1$4, $a#2_1$4);
		    		n_1$4 := $t#4_1$4 ;
		    		assume $ReadObject($h_1$4, $t#4_1$4);
		    		$t#5_1$4 := $Read($h_1$4,r0_1$4,$field#v) ;
		    		assume $ReadObject($h_1$4, r0_1$4);
		    		assume $ReadObject($h_1$4, $Read($h_1$4,r0_1$4,$field#v) );
		    		$h_1$4:=$Write($h_1$4,n_1$4,$field#f,$t#5_1$4); assume $GoodHeap($h_1$4);
		    		$t#6_1$4 := $Read($h_1$4,r1_1$4,$field#v) ;
		    		assume $ReadObject($h_1$4, r1_1$4);
		    		assume $ReadObject($h_1$4, $Read($h_1$4,r1_1$4,$field#v) );
		    		$h_1$4:=$Write($h_1$4,n_1$4,$field#g,$t#6_1$4); assume $GoodHeap($h_1$4);
		    ...
		    if((x_0$5  != $Null ) )
		    {
		    	if((r_0$5  != $Null ) )
		    	{
		    		...
		    		$t#3_0$5 := $Read($h_0$5,x_0$5,$field#f) ;
		    		assume $ReadObject($h_0$5, x_0$5);
		    		assume $ReadObject($h_0$5, $Read($h_0$5,x_0$5,$field#f) );
		    		t0_0$5 := $t#3_0$5 ;
		    		assume $ReadObject($h_0$5, $t#3_0$5);
		    		 call $h_0$5:=CopyTree_0(5, $h_0$5, $roots, t0_0$5, r0_0$5); 
		    		$t#4_0$5 := $Read($h_0$5,x_0$5,$field#g) ;
		    		assume $ReadObject($h_0$5, x_0$5);
		    		assume $ReadObject($h_0$5, $Read($h_0$5,x_0$5,$field#g) );
		    		t1_0$5 := $t#4_0$5 ;
		    		assume $ReadObject($h_0$5, $t#4_0$5);
		    		 call $h_0$5:=CopyTree_0(5, $h_0$5, $roots, t1_0$5, r1_0$5); 
		    		$t#5_0$5 := $Read($h_0$5,r0_0$5,$field#v) ;
		    		assume $ReadObject($h_0$5, r0_0$5);
		    		assume $ReadObject($h_0$5, $Read($h_0$5,r0_0$5,$field#v) );
		    		$h_0$5:=$Write($h_0$5,n_0$5,$field#f,$t#5_0$5); assume $GoodHeap($h_0$5);
		    		$t#6_0$5 := $Read($h_0$5,r1_0$5,$field#v) ;
		    		assume $ReadObject($h_0$5, r1_0$5);
		    		assume $ReadObject($h_0$5, $Read($h_0$5,r1_0$5,$field#v) );
		    		$h_0$5:=$Write($h_0$5,n_0$5,$field#g,$t#6_0$5); assume $GoodHeap($h_0$5);
		    ...
		    if((x_1$5  != $Null ) )
		    {
		    	if((r_1$5  != $Null ) )
		    	{
		    		...
		    		$t#2_1$5 := $Read($h_1$5,x_1$5,$field#g) ;
		    		assume $ReadObject($h_1$5, x_1$5);
		    		assume $ReadObject($h_1$5, $Read($h_1$5,x_1$5,$field#g) );
		    		t0_1$5 := $t#2_1$5 ;
		    		assume $ReadObject($h_1$5, $t#2_1$5);
		    		 call $h_1$5:=CopyTree_1(5, $h_1$5, $roots, t0_1$5, r1_1$5); 
		    		$t#3_1$5 := $Read($h_1$5,x_1$5,$field#f) ;
		    		assume $ReadObject($h_1$5, x_1$5);
		    		assume $ReadObject($h_1$5, $Read($h_1$5,x_1$5,$field#f) );
		    		t1_1$5 := $t#3_1$5 ;
		    		assume $ReadObject($h_1$5, $t#3_1$5);
		    		 call $h_1$5:=CopyTree_1(5, $h_1$5, $roots, t1_1$5, r0_1$5); 
		    		$t#4_1$5 := $a#2_1$5 ;
		    		assume $ReadObject($h_1$5, $a#2_1$5);
		    		n_1$5 := $t#4_1$5 ;
		    		assume $ReadObject($h_1$5, $t#4_1$5);
		    		$t#5_1$5 := $Read($h_1$5,r0_1$5,$field#v) ;
		    		assume $ReadObject($h_1$5, r0_1$5);
		    		assume $ReadObject($h_1$5, $Read($h_1$5,r0_1$5,$field#v) );
		    		$h_1$5:=$Write($h_1$5,n_1$5,$field#f,$t#5_1$5); assume $GoodHeap($h_1$5);
		    		$t#6_1$5 := $Read($h_1$5,r1_1$5,$field#v) ;
		    		assume $ReadObject($h_1$5, r1_1$5);
		    		assume $ReadObject($h_1$5, $Read($h_1$5,r1_1$5,$field#v) );
		    		$h_1$5:=$Write($h_1$5,n_1$5,$field#g,$t#6_1$5); assume $GoodHeap($h_1$5);

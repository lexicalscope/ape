...
function $abs_Swap_0($strategy:int, $h_pre:Heap, x_0:Ref,y_0:Ref, $h_post:Heap):bool;

// version _0 of the procedure
procedure Swap_0($strategy:int, $h:Heap, $roots:Roots, x:Ref,y:Ref) returns ($h_0:Heap)
    ...
    free ensures $abs_Swap_0($strategy, $h, x, y, $h_0);
     ...
     /* modifies anything */  
{
	...
	z_0 := $Null;
			...
			$t#1_0 := $Read($h_0,x_0,$field#v) ;
			assume $ReadObject($h_0, x_0);
			assume $ReadObject($h_0, $Read($h_0,x_0,$field#v) );
			$h_0:=$Write($h_0,z_0,$field#v,$t#1_0); assume $GoodHeap($h_0);
			$t#2_0 := $Read($h_0,y_0,$field#v) ;
			assume $ReadObject($h_0, y_0);
			assume $ReadObject($h_0, $Read($h_0,y_0,$field#v) );
			$h_0:=$Write($h_0,x_0,$field#v,$t#2_0); assume $GoodHeap($h_0);
			$t#3_0 := $Read($h_0,z_0,$field#v) ;
			assume $ReadObject($h_0, z_0);
			assume $ReadObject($h_0, $Read($h_0,z_0,$field#v) );
			$h_0:=$Write($h_0,y_0,$field#v,$t#3_0); assume $GoodHeap($h_0);

}

// abstraction of function behaviour
function $abs_Swap_1($strategy:int, $h_pre:Heap, x_1:Ref,y_1:Ref, $h_post:Heap):bool;

// version _1 of the procedure
procedure Swap_1($strategy:int, $h:Heap, $roots:Roots, x:Ref,y:Ref) returns ($h_1:Heap)
    requires $Allocated($h, x) && $Allocated($h, y);
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
    requires $Roots#Allocated($roots, $h);
    ...
    free ensures $abs_Swap_1($strategy, $h, x, y, $h_1);
     ...
     /* modifies anything */  
{
	...
	z_1 := $Null;
			...
			$t#0_1 := $Read($h_1,x_1,$field#v) ;
			assume $ReadObject($h_1, x_1);
			assume $ReadObject($h_1, $Read($h_1,x_1,$field#v) );
			z_1 := $t#0_1 ;
			assume $ReadObject($h_1, $t#0_1);
			$t#1_1 := $Read($h_1,y_1,$field#v) ;
			assume $ReadObject($h_1, y_1);
			assume $ReadObject($h_1, $Read($h_1,y_1,$field#v) );
			$h_1:=$Write($h_1,x_1,$field#v,$t#1_1); assume $GoodHeap($h_1);
			$h_1:=$Write($h_1,y_1,$field#v,z_1); assume $GoodHeap($h_1);
...
axiom (forall 
			...
			{
				$abs_Swap_0($allocator, $h0_0 , x_0, y_0, $hn_0) ,
				$abs_Swap_1($allocator, $h0_1 , x_1, y_1, $hn_1) 
			}
			$abs_Swap_0($allocator, $h0_0 , x_0, y_0, $hn_0) &&
			$abs_Swap_1($allocator, $h0_1 , x_1, y_1, $hn_1) &&
...
// product procedure
procedure Swap_Swap($h:Heap, $roots:Roots, x:Ref,y:Ref)
    requires $GoodHeap($h);
    requires $GoodRoots($roots);
	requires $Roots#Allocated($roots, $h);
	requires $Allocated($h, x) && $Allocated($h, y);
	...
	requires (forall $a:Ref :: $Reachable($h, $roots, $a) ==> $Allocated($h, $a)); // should be an axiom of well formed heaps
{
    ...
    assume $ReadObject($h,y);
		    ...
		    $t#1_0$0 := $Read($h_0$0,x_0$0,$field#v) ;
		    assume $ReadObject($h_0$0, x_0$0);
		    assume $ReadObject($h_0$0, $Read($h_0$0,x_0$0,$field#v) );
		    $h_0$0:=$Write($h_0$0,z_0$0,$field#v,$t#1_0$0); assume $GoodHeap($h_0$0);
		    $t#2_0$0 := $Read($h_0$0,y_0$0,$field#v) ;
		    assume $ReadObject($h_0$0, y_0$0);
		    assume $ReadObject($h_0$0, $Read($h_0$0,y_0$0,$field#v) );
		    $h_0$0:=$Write($h_0$0,x_0$0,$field#v,$t#2_0$0); assume $GoodHeap($h_0$0);
		    $t#3_0$0 := $Read($h_0$0,z_0$0,$field#v) ;
		    assume $ReadObject($h_0$0, z_0$0);
		    assume $ReadObject($h_0$0, $Read($h_0$0,z_0$0,$field#v) );
		    $h_0$0:=$Write($h_0$0,y_0$0,$field#v,$t#3_0$0); assume $GoodHeap($h_0$0);
		    ...
		    $t#0_1$0 := $Read($h_1$0,x_1$0,$field#v) ;
		    assume $ReadObject($h_1$0, x_1$0);
		    assume $ReadObject($h_1$0, $Read($h_1$0,x_1$0,$field#v) );
		    z_1$0 := $t#0_1$0 ;
		    assume $ReadObject($h_1$0, $t#0_1$0);
		    $t#1_1$0 := $Read($h_1$0,y_1$0,$field#v) ;
		    assume $ReadObject($h_1$0, y_1$0);
		    assume $ReadObject($h_1$0, $Read($h_1$0,y_1$0,$field#v) );
		    $h_1$0:=$Write($h_1$0,x_1$0,$field#v,$t#1_1$0); assume $GoodHeap($h_1$0);
		    $h_1$0:=$Write($h_1$0,y_1$0,$field#v,z_1$0); assume $GoodHeap($h_1$0);
